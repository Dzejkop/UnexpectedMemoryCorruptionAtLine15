...
function Poof.render(self)
  ...
  for poof=0,self.num_of_arms do
    ...
    spr_center(current_sprite, poof_pos.x, poof_pos.y, 8, 8, 0)
  end
end
...
function player_update(delta)
  ...
  if not Player.is_dead then
    local player_is_within_map =
          Player.pos.x >= 0
      and Player.pos.y >= 0
      and Player.pos.x < SCR_WIDTH
      and Player.pos.y < SCR_HEIGHT
...
-- 012:
