...
function Enemies:update()
  for _, enemy in ipairs(self.active_enemies) do
    ...
    if enemy.collision_radius then
      x1 = enemy.pos.x + enemy:width() / 2
      y1 = enemy:y() + enemy:height() / 2
      x2 = PLAYER.pos.x + Player:width() / 2
      y2 = PLAYER.pos.y + Player:height() / 2
...
function LostSoulEnemy:update()
  if TICKS % math.random(15, 45) == 0 then
    local pos = Vec.new(
      self.pos.x + TILE_SIZE + math.random(-10, 10),
      self.pos.y + TILE_SIZE + math.random(-10, 10)
    )
...
function LostSoulEnemy:render()
  local offset = LEVELS.shift_offset():mul(-TILE_SIZE)
  local pos = self.pos:add(offset)
...
function SpiderEnemy:y()
  return self.pos.y + self.len
end
...
-- <MAP>
-- 000:
-- 001:
-- 002:
-- 003:
-- 004:
-- 005:
-- 006:
-- 007:
-- 008:
-- 009:
-- 010:
-- 011:
-- 012:
-- 013:
